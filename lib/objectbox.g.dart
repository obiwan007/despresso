...
final _entities = <ModelEntity>[
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ...
        ModelProperty(id: const IdUid(16, 4933890882353956688), name: 'totalDissolvedSolidss', type: 8, flags: 0),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      ...
      retiredEntityUids: const [2372411160892302204, 5004946134676291479, 6316057013526616538],
  ...
  final bindings = <Type, EntityDefinition>{
    Shot: EntityDefinition<Shot>(
        ...
        objectToFB: (Shot object, fb.Builder fbb) {
          ...
          fbb.addFloat64(15, object.totalDissolvedSolids);
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Shot()
            ...
            ..totalDissolvedSolids = const fb.Float64Reader().vTableGet(buffer, rootOffset, 34, 0)
...
class Shot_ {
  ...
  static final totalDissolvedSolidss = QueryDoubleProperty<Shot>(_entities[0].properties[15]);

  /// see [Shot.extractionYield]
  static final extractionYield = QueryDoubleProperty<Shot>(_entities[0].properties[16]);

  /// see [Shot.enjoyment]
  static final enjoyment = QueryDoubleProperty<Shot>(_entities[0].properties[17]);

  /// see [Shot.barrista]
  static final barrista = QueryStringProperty<Shot>(_entities[0].properties[18]);
