  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Shot: obx_int.EntityDefinition<Shot>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Shot()
          ...
          ..profileId = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 10, '')
          ..pourTime = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            12,
            0,
          )
          ..pourWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            14,
            0,
          )
          ..targetEspressoWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            16,
            0,
          )
          ..targetTempCorrection = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            18,
            0,
          )
          ..doseWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            22,
            0,
          )
          ..drinkWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            24,
            0,
          )
          ..grinderSettings = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            26,
            0,
          ...
          ..grinderName = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 30, '')
          ..roastingDate = DateTime.fromMillisecondsSinceEpoch(
            const fb.Int64Reader().vTableGet(buffer, rootOffset, 32, 0),
          )
          ..extractionYield = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            36,
            0,
          )
          ..enjoyment = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            38,
            0,
          )
          ..barrista = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 40, '')
          ..drinker = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 42, '')
          ..totalDissolvedSolids = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            44,
            0,
          )
          ..visualizerId = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 46, '')
          ..estimatedWeightReachedTime = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            48,
            0,
          )
          ..estimatedWeight_m = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            50,
            0,
          )
          ..estimatedWeight_b = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            52,
            0,
          )
          ..estimatedWeight_tEnd = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            54,
            0,
          )
          ..estimatedWeight_tStart = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            56,
            0,
          )
          ..ratio1 = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            58,
            0,
          )
          ..ratio2 = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            60,
            0,
          );
        object.coffee.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          8,
          0,
        ...
        obx_int.InternalToManyAccess.setRelInfo<Shot>(
          object.shotstates,
          store,
          obx_int.RelInfo<Shot>.toMany(1, object.id),
        );
        return object;
      },
    ),
    Coffee: obx_int.EntityDefinition<Coffee>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Coffee()
          ...
          ..acidRating = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            14,
            0,
          )
          ..intensityRating = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            16,
            0,
          )
          ..roastLevel = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            18,
            0,
          ...
          ..taste = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 32, '')
          ..grinderDoseWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            34,
            0,
          ...
          ..region = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 38, '')
          ..farm = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 40, '')
          ..cropyear = DateTime.fromMillisecondsSinceEpoch(
            const fb.Int64Reader().vTableGet(buffer, rootOffset, 42, 0),
          )
          ..process = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 44, '')
          ..elevation = const fb.Int64Reader().vTableGet(
            buffer,
            rootOffset,
            46,
            0,
          )
          ..isShot = const fb.BoolReader().vTableGet(
            buffer,
            rootOffset,
            48,
            false,
          );
        object.roaster.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          8,
          0,
    ...
    Roaster: obx_int.EntityDefinition<Roaster>(
      ...
      toManyRelations: (Roaster object) => {
        obx_int.RelInfo<Coffee>.toOneBacklink(
          3,
          object.id,
          (Coffee srcObject) => srcObject.roaster,
        ): object.coffees,
      },
    ...
    ShotState: obx_int.EntityDefinition<ShotState>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        final buffer = fb.BufferContext(fbData);
        final rootOffset = buffer.derefObject(0);
        final sampleTimeParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          10,
          0,
        );
        final sampleTimeCorrectedParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
        );
        final groupPressureParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          16,
          0,
        );
        final groupFlowParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          18,
          0,
        );
        final mixTempParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          20,
          0,
        );
        final headTempParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          22,
          0,
        );
        final setMixTempParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          24,
          0,
        );
        final setHeadTempParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          26,
          0,
        );
        final setGroupPressureParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          28,
          0,
        );
        final setGroupFlowParam = const fb.Float64Reader().vTableGet(
          buffer,
          rootOffset,
          30,
          0,
        );
        final frameNumberParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          34,
          0,
        );
        final steamTempParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          36,
          0,
        ...
        final subStateParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 6, '');
        final object =
            ShotState(
              ...
              ..flowWeight = const fb.Float64Reader().vTableGet(
                buffer,
                rootOffset,
                32,
                0,
    ...
    Recipe: obx_int.EntityDefinition<Recipe>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Recipe()
          ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0)
          ..adjustedWeight = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            8,
            0,
          )
          ..adjustedPressure = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            10,
            0,
          )
          ..adjustedTemp = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            12,
            0,
          ...
          ..weightWater = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            32,
            0,
          )
          ..useWater = const fb.BoolReader().vTableGet(
            buffer,
            rootOffset,
            34,
            false,
          )
          ..tempWater = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            36,
            0,
          )
          ..timeWater = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            38,
            0,
          )
          ..tempSteam = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            40,
            0,
          )
          ..flowSteam = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            42,
            0,
          )
          ..timeSteam = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            44,
            0,
          )
          ..weightMilk = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            46,
            0,
          )
          ..useSteam = const fb.BoolReader().vTableGet(
            buffer,
            rootOffset,
            48,
            false,
          ...
          ..grinderModel = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 52, '')
          ..disableStopOnWeight = const fb.BoolReader().vTableGet(
            buffer,
            rootOffset,
            56,
            false,
    ...
    SettingsEntry: obx_int.EntityDefinition<SettingsEntry>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = SettingsEntry()
          ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0)
          ..doubleVal = const fb.Float64Reader().vTableGet(
            buffer,
            rootOffset,
            6,
            0,
          ...
          ..stringVal = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGet(buffer, rootOffset, 10, '')
          ..boolVal = const fb.BoolReader().vTableGet(
            buffer,
            rootOffset,
            12,
            false,
...
class Shot_ {
  ...
  /// See [Shot.coffee].
  static final coffee = obx.QueryRelationToOne<Shot, Coffee>(
    _entities[0].properties[2],
  );

  /// See [Shot.profileId].
  static final profileId = obx.QueryStringProperty<Shot>(
    _entities[0].properties[3],
  );

  /// See [Shot.pourTime].
  static final pourTime = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[4],
  );

  /// See [Shot.pourWeight].
  static final pourWeight = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[5],
  );

  /// See [Shot.targetEspressoWeight].
  static final targetEspressoWeight = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[6],
  );

  /// See [Shot.targetTempCorrection].
  static final targetTempCorrection = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[7],
  );

  /// See [Shot.recipe].
  static final recipe = obx.QueryRelationToOne<Shot, Recipe>(
    _entities[0].properties[8],
  );

  /// See [Shot.doseWeight].
  static final doseWeight = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[9],
  );

  /// See [Shot.drinkWeight].
  static final drinkWeight = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[10],
  );

  /// See [Shot.grinderSettings].
  static final grinderSettings = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[11],
  );

  /// See [Shot.description].
  static final description = obx.QueryStringProperty<Shot>(
    _entities[0].properties[12],
  );

  /// See [Shot.grinderName].
  static final grinderName = obx.QueryStringProperty<Shot>(
    _entities[0].properties[13],
  );

  /// See [Shot.roastingDate].
  static final roastingDate = obx.QueryDateProperty<Shot>(
    _entities[0].properties[14],
  );

  /// See [Shot.extractionYield].
  static final extractionYield = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[15],
  );

  /// See [Shot.enjoyment].
  static final enjoyment = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[16],
  );

  /// See [Shot.barrista].
  static final barrista = obx.QueryStringProperty<Shot>(
    _entities[0].properties[17],
  );

  /// See [Shot.drinker].
  static final drinker = obx.QueryStringProperty<Shot>(
    _entities[0].properties[18],
  );

  /// See [Shot.totalDissolvedSolids].
  static final totalDissolvedSolids = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[19],
  );

  /// See [Shot.visualizerId].
  static final visualizerId = obx.QueryStringProperty<Shot>(
    _entities[0].properties[20],
  );

  /// See [Shot.estimatedWeightReachedTime].
  static final estimatedWeightReachedTime = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[21],
  );

  /// See [Shot.estimatedWeight_m].
  static final estimatedWeight_m = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[22],
  );

  /// See [Shot.estimatedWeight_b].
  static final estimatedWeight_b = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[23],
  );

  /// See [Shot.estimatedWeight_tEnd].
  static final estimatedWeight_tEnd = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[24],
  );

  /// See [Shot.estimatedWeight_tStart].
  static final estimatedWeight_tStart = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[25],
  );

  /// See [Shot.ratio1].
  static final ratio1 = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[26],
  );

  /// See [Shot.ratio2].
  static final ratio2 = obx.QueryDoubleProperty<Shot>(
    _entities[0].properties[27],
  );

  /// see [Shot.shotstates]
  static final shotstates = obx.QueryRelationToMany<Shot, ShotState>(
...
class Coffee_ {
  /// See [Coffee.id].
  static final id = obx.QueryIntegerProperty<Coffee>(
    _entities[1].properties[0],
  );

  /// See [Coffee.name].
  static final name = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[1],
  );

  /// See [Coffee.roaster].
  static final roaster = obx.QueryRelationToOne<Coffee, Roaster>(
    _entities[1].properties[2],
  );

  /// See [Coffee.imageURL].
  static final imageURL = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[3],
  );

  /// See [Coffee.grinderSettings].
  static final grinderSettings = obx.QueryDoubleProperty<Coffee>(
    _entities[1].properties[4],
  );

  /// See [Coffee.acidRating].
  static final acidRating = obx.QueryDoubleProperty<Coffee>(
    _entities[1].properties[5],
  );

  /// See [Coffee.intensityRating].
  static final intensityRating = obx.QueryDoubleProperty<Coffee>(
    _entities[1].properties[6],
  );

  /// See [Coffee.roastLevel].
  static final roastLevel = obx.QueryDoubleProperty<Coffee>(
    _entities[1].properties[7],
  );

  /// See [Coffee.description].
  static final description = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[8],
  );

  /// See [Coffee.origin].
  static final origin = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[9],
  );

  /// See [Coffee.price].
  static final price = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[10],
  );

  /// See [Coffee.type].
  static final type = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[11],
  );

  /// See [Coffee.taste].
  static final taste = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[12],
  );

  /// See [Coffee.grinderDoseWeight].
  static final grinderDoseWeight = obx.QueryDoubleProperty<Coffee>(
    _entities[1].properties[13],
  );

  /// See [Coffee.roastDate].
  static final roastDate = obx.QueryDateProperty<Coffee>(
    _entities[1].properties[14],
  );

  /// See [Coffee.region].
  static final region = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[15],
  );

  /// See [Coffee.farm].
  static final farm = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[16],
  );

  /// See [Coffee.cropyear].
  static final cropyear = obx.QueryDateProperty<Coffee>(
    _entities[1].properties[17],
  );

  /// See [Coffee.process].
  static final process = obx.QueryStringProperty<Coffee>(
    _entities[1].properties[18],
  );

  /// See [Coffee.elevation].
  static final elevation = obx.QueryIntegerProperty<Coffee>(
    _entities[1].properties[19],
  );

  /// See [Coffee.isShot].
  static final isShot = obx.QueryBooleanProperty<Coffee>(
...
class Roaster_ {
  /// See [Roaster.id].
  static final id = obx.QueryIntegerProperty<Roaster>(
    _entities[2].properties[0],
  );

  /// See [Roaster.name].
  static final name = obx.QueryStringProperty<Roaster>(
    _entities[2].properties[1],
  );

  /// See [Roaster.imageURL].
  static final imageURL = obx.QueryStringProperty<Roaster>(
    _entities[2].properties[2],
  );

  /// See [Roaster.description].
  static final description = obx.QueryStringProperty<Roaster>(
    _entities[2].properties[3],
  );

  /// See [Roaster.address].
  static final address = obx.QueryStringProperty<Roaster>(
    _entities[2].properties[4],
  );

  /// See [Roaster.homepage].
  static final homepage = obx.QueryStringProperty<Roaster>(
    _entities[2].properties[5],
  );

  /// see [Roaster.coffees]
  static final coffees = obx.QueryBacklinkToMany<Coffee, Roaster>(
    Coffee_.roaster,
  );
}
...
class ShotState_ {
  /// See [ShotState.id].
  static final id = obx.QueryIntegerProperty<ShotState>(
    _entities[3].properties[0],
  );

  /// See [ShotState.subState].
  static final subState = obx.QueryStringProperty<ShotState>(
    _entities[3].properties[1],
  );

  /// See [ShotState.weight].
  static final weight = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[2],
  );

  /// See [ShotState.sampleTime].
  static final sampleTime = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[3],
  );

  /// See [ShotState.sampleTimeCorrected].
  static final sampleTimeCorrected = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[4],
  );

  /// See [ShotState.pourTime].
  static final pourTime = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[5],
  );

  /// See [ShotState.groupPressure].
  static final groupPressure = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[6],
  );

  /// See [ShotState.groupFlow].
  static final groupFlow = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[7],
  );

  /// See [ShotState.mixTemp].
  static final mixTemp = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[8],
  );

  /// See [ShotState.headTemp].
  static final headTemp = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[9],
  );

  /// See [ShotState.setMixTemp].
  static final setMixTemp = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[10],
  );

  /// See [ShotState.setHeadTemp].
  static final setHeadTemp = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[11],
  );

  /// See [ShotState.setGroupPressure].
  static final setGroupPressure = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[12],
  );

  /// See [ShotState.setGroupFlow].
  static final setGroupFlow = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[13],
  );

  /// See [ShotState.flowWeight].
  static final flowWeight = obx.QueryDoubleProperty<ShotState>(
    _entities[3].properties[14],
  );

  /// See [ShotState.frameNumber].
  static final frameNumber = obx.QueryIntegerProperty<ShotState>(
    _entities[3].properties[15],
  );

  /// See [ShotState.steamTemp].
  static final steamTemp = obx.QueryIntegerProperty<ShotState>(
...
class Favorite_ {
  ...
  /// See [Favorite.recipe].
  static final recipe = obx.QueryRelationToOne<Favorite, Recipe>(
...
class Recipe_ {
  ...
  /// See [Recipe.coffee].
  static final coffee = obx.QueryRelationToOne<Recipe, Coffee>(
    _entities[5].properties[1],
  );

  /// See [Recipe.adjustedWeight].
  static final adjustedWeight = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[2],
  );

  /// See [Recipe.adjustedPressure].
  static final adjustedPressure = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[3],
  );

  /// See [Recipe.adjustedTemp].
  static final adjustedTemp = obx.QueryDoubleProperty<Recipe>(
  ...
  static final profileId = obx.QueryStringProperty<Recipe>(
    _entities[5].properties[6],
  );

  /// See [Recipe.grinderDoseWeight].
  static final grinderDoseWeight = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[7],
  );

  /// See [Recipe.grinderSettings].
  static final grinderSettings = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[8],
  );

  /// See [Recipe.isDeleted].
  static final isDeleted = obx.QueryBooleanProperty<Recipe>(
  ...
  /// See [Recipe.ratio1].
  static final ratio1 = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[11],
  );

  /// See [Recipe.ratio2].
  static final ratio2 = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[12],
  );

  /// See [Recipe.weightWater].
  static final weightWater = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[13],
  );

  /// See [Recipe.useWater].
  static final useWater = obx.QueryBooleanProperty<Recipe>(
    _entities[5].properties[14],
  );

  /// See [Recipe.tempWater].
  static final tempWater = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[15],
  );

  /// See [Recipe.timeWater].
  static final timeWater = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[16],
  );

  /// See [Recipe.tempSteam].
  static final tempSteam = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[17],
  );

  /// See [Recipe.flowSteam].
  static final flowSteam = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[18],
  );

  /// See [Recipe.timeSteam].
  static final timeSteam = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[19],
  );

  /// See [Recipe.weightMilk].
  static final weightMilk = obx.QueryDoubleProperty<Recipe>(
    _entities[5].properties[20],
  );

  /// See [Recipe.useSteam].
  static final useSteam = obx.QueryBooleanProperty<Recipe>(
  ...
  static final grinderModel = obx.QueryStringProperty<Recipe>(
    _entities[5].properties[23],
  );

  /// See [Recipe.disableStopOnWeight].
  static final disableStopOnWeight = obx.QueryBooleanProperty<Recipe>(
    _entities[5].properties[24],
  );

  /// See [Recipe.isShot].
  static final isShot = obx.QueryBooleanProperty<Recipe>(
...
class SettingsEntry_ {
  ...
  static final id = obx.QueryIntegerProperty<SettingsEntry>(
    _entities[6].properties[0],
  );

  /// See [SettingsEntry.doubleVal].
  static final doubleVal = obx.QueryDoubleProperty<SettingsEntry>(
    _entities[6].properties[1],
  );

  /// See [SettingsEntry.intVal].
  static final intVal = obx.QueryIntegerProperty<SettingsEntry>(
    _entities[6].properties[2],
  );

  /// See [SettingsEntry.stringVal].
  static final stringVal = obx.QueryStringProperty<SettingsEntry>(
    _entities[6].properties[3],
  );

  /// See [SettingsEntry.boolVal].
  static final boolVal = obx.QueryBooleanProperty<SettingsEntry>(
    _entities[6].properties[4],
  );

  /// See [SettingsEntry.key].
  static final key = obx.QueryStringProperty<SettingsEntry>(
    _entities[6].properties[5],
  );

  /// See [SettingsEntry.type].
  static final type = obx.QueryStringProperty<SettingsEntry>(
