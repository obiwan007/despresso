                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      createKeyValue("Beverage", _selectedProfile!.shot_header.beverage_type),
                      createKeyValue("Type", _selectedProfile!.shot_header.type),
                      createKeyValue("Max Flow", _selectedProfile!.shot_header.maximumFlow.toString()),
                      createKeyValue("Max Pressure", _selectedProfile!.shot_header.minimumPressure.toString()),
                      createKeyValue("Target Volume", _selectedProfile!.shot_header.target_volume.toString()),
                      createKeyValue("Target Weight", _selectedProfile!.shot_header.target_weight.toString()),
                    ],
                  ),
                ),
              ),
